...
_Target
    ...
    (fun _ -> // Needs debug because release is compiled --standalone which contaminates everything
        ...
        [ ([ Path.getFullName "_Binaries/AltCode.Dixon/Debug+x86/net472/AltCode.Dixon.dll" ], [], nonFsharpRules) ]
        |> Seq.iter
...
_Target
    ...
    (fun _ ->
        ...
        [ (productFiles, "_Packaging", "./Build/altcode.dixon.nuspec", "AltCode.Dixon", "FxCop extensions", []) ]
        |> List.iter
            (fun (files, output, nuspec, project, description, dependencies) ->
