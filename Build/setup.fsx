...
nuget Fake.DotNet.ILMerge >= 5.21.1
nuget Fake.DotNet.MSBuild >= 5.21.1
nuget Fake.DotNet.NuGet >= 5.21.1
nuget Fake.DotNet.Testing.NUnit >= 5.21.1
nuget Fake.DotNet.Testing.OpenCover >= 5.21.1
nuget Fake.DotNet.Testing.XUnit2 >= 5.21.1
nuget Fake.IO.FileSystem >= 5.21.1
nuget Fake.DotNet.Testing.Coverlet >= 5.21.1
nuget Fake.Testing.ReportGenerator >= 5.21.1
nuget Fake.Tools.Git >= 5.21.1
nuget altcover.fake >= 8.2.825
