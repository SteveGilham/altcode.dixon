...
module Utilities =
  ...
  [<assembly: SuppressMessage("Microsoft.Reliability", "CA2001:AvoidCallingProblematicMethods",
    Scope="member", Target="AltCode.Dixon.Utilities.#FindRuleClass(System.String,System.String)",
  ...
  [<assembly: SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly",
    Scope="member", Target="AltCode.Dixon.Utilities.#Option`1.getOrElse.Static`1(!!0,Microsoft.FSharp.Core.FSharpOption`1<!!0>)",
    MessageId="get", Justification="to be fixed at source")>]
  ...
  [<assembly: SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly",
    Scope="member", Target="AltCode.Dixon.Utilities.#Option`1.getOrElse.Static`1(!!0,Microsoft.FSharp.Core.FSharpOption`1<!!0>)",
    MessageId="fallback", Justification="tto be fixed at source")>]
  ...
  [<assembly: SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly",
    Scope="member", Target="AltCode.Dixon.Utilities.#Option`1.getOrElse.Static`1(!!0,Microsoft.FSharp.Core.FSharpOption`1<!!0>)",
    MessageId="x", Justification="to be fixed at source")>]
  ()